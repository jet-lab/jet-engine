...
export class JetObligation implements Obligation {
  ...
  private static toTokens(deposit: TokenAmount, collateral: TokenAmount, loan: TokenAmount, reserve: ReserveData, reserveCache: JetMarketReserveInfo): Balances {
    return {
